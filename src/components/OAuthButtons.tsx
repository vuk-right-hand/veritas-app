...
export function OAuthButtons({ flow, extraScopes = [], onBeforeRedirect, className }: OAuthButtonsProps) {
    ...
    const handleOAuth = async (provider: 'google' | 'github') => {
        ...
        const scopes = provider === 'google' && extraScopes.length > 0
            ? extraScopes.join(' ')
            : undefined;
        ...
        if (error) {
            console.error('[OAuthButtons] Error:', error.message);
        }
        ...
        <div className={className}>
            <div className="space-y-3">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white text-black font-semibold rounded-xl hover:bg-gray-100 transition-all"
                >
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-[#24292e] text-white font-semibold rounded-xl hover:bg-[#2f363d] transition-all"
                >
