...
export const metadata = {
  title: "Terms of Service — VibeCodersHQ",
  description: "Terms and conditions for using the VibeCodersHQ platform.",
};
        ...
        <article className="space-y-10">
          ...
          <section className="bg-[#0f0f0f] border border-white/5 rounded-2xl p-6 md:p-10">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              VibeCodersHQ operates as an educational curation layer. We do not host,
          ...
          <section className="bg-[#0f0f0f] border border-white/5 rounded-2xl p-6 md:p-10">
            <h2 className="text-xl font-bold text-white mb-4">
              2. VibeCodersHQ Intellectual Property
            </h2>
            <p className="text-gray-400 leading-relaxed">
              While we do not own the embedded videos, VibeCodersHQ retains all
          ...
          <section className="bg-[#0f0f0f] border border-white/5 rounded-2xl p-6 md:p-10">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              VibeCodersHQ is designed to verify actual human learning. To maintain
